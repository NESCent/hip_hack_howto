...
* Rutger
    ...
    * We should look at the paper trial of the various events and determine the tangible products (publications, proposals)
...
* Summary 
    * We should develope a report describing our organization protocol for hackathons
    * We need to assess the value of hackathons (that's the hard part)
    * It should be evidence-based
    * NEAD is a powerful resource we could use
    * We should define our target audience - probably organizers/proposers of hackathons
